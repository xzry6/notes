...
![back-propagation](../assets/backPropagation.png)

## 深度置信网在生物信息学中的应用
一个蛋白质序列由一组氨基酸组成。课题研究的是当每个氨基酸发生突变时，对蛋白质整体能量的变化。[论文](http://52.8.152.237/sean/wp-content/uploads/2016/05/DNpro-A-Deep-Learning-Network-
